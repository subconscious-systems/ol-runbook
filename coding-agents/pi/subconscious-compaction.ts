 ...
 *
 * Note: Pi docs say compaction/branch-summary requests may use fresh routing
 * session IDs. If affinity on the summarization call differs, start/end still
 * open the epoch on the parent session via the retained-drop guard, but the
 * boundary charge may be empty.
 *
