# glm-5.2-nvfp4-b200-4gpu on GCP
...
| Image | `registry.distr.sh/subconscious/timrun:sm_100-v0.13` |
| Model path | `/mnt/model-test/glm-5.2-nvfp4` |
...
```bash
cd gpu-deployment/gcp/glm-5.2-nvfp4-b200-4gpu
cp .env.example .env
