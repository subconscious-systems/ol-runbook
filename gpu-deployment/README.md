...
```bash
test -f /mnt/model-test/glm-5.2-nvfp4/config.json
find /mnt/model-test/glm-5.2-nvfp4 -maxdepth 1 -name '*.safetensors' | head
test -f /mnt/model-test/glm-5.2-fp8-dflash-v2/config.json
```
