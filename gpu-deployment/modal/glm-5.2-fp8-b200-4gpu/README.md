# GLM-5.2 FP8 on 4 B200 GPUs

| Setting | Value |
| --- | --- |
| Modal app | `subconscious-glm-5-2-fp8-b200-4gpu` |
...
| Cache volume | `subconscious-glm-5-2-fp8-b200-4gpu-cache` |
...
```bash
uv run --frozen modal app stop subconscious-glm-5-2-fp8-b200-4gpu
```
