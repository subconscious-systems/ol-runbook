# qwen36-27b-a100-80gb-2gpu on Azure
...
| Helper instance default | `Standard_NC48ads_A100_v4` |
...
```bash
cd gpu-deployment/azure/qwen36-27b-a100-80gb-2gpu
cp .env.example .env
