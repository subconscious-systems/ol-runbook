# qwen36-27b-a100-80gb-1gpu on Azure
...
| Helper instance default | `Standard_NC24ads_A100_v4` |
...
```bash
cd gpu-deployment/azure/qwen36-27b-a100-80gb-1gpu
cp .env.example .env
