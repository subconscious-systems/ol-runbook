# qwen36-27b-h100-80gb-8gpu on Azure
...
| Helper instance default | `Standard_ND96isr_H100_v5` |
...
```bash
cd gpu-deployment/azure/qwen36-27b-h100-80gb-8gpu
cp .env.example .env
